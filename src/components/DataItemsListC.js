...
class DataItemsListC extends Component {
    ...
    renderItems(){
        ...
        this.state.items.map(value=>{
            items.push(this.renderSingleItem(value.icon, value.title, value.sub_title, value.text,value.link));
        });
        return items
    }
    ...
    renderSingleItem(icon, title, sub_title, text, link){
        ...
        return <Grid item>
            <DataItemC icon={icon} title={title} sub_title={sub_title} text={text} button={button}/>
        </Grid>
    }
