...
class RequestsC extends Component {
    ...
    render() {
        return (
            <div>
                <Switch>
                    <Route path="/requests/:uuid" render={(match)=>
                        <Grid item>
                            <InformationViewC match={match} item_type="Request" title="Request" sub_title="Supply Request " setToolbarTitle={this.setToolbarTitle.bind(this)}/>
                        </Grid>
                    }/>
                    <Route path="/requests" render={()=>
                        <DataItemsListC item_type="Request" setToolbarTitle={this.setToolbarTitle.bind(this)}/>
                    }/>
                </Switch>
            </div>
        );
