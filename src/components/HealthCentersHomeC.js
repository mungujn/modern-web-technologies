...
class HealthCentersHomeC extends Component {
    ...
    constructor(){
        super();
        this.state = {
            buttons : [{text: "Add Health Center", link: "\"/health-centers/add\""}]
        }
    }
    ...
    componentDidMount(){
        this.setButtons([{text: "Add Health Center", link: "/health-centers/add"}]);
            ...
            <div>
                <Grid container align="flex-start" direction="column" justify="space-around">
                    ...
                    <Grid item style={section_style}>
                        <Switch>
                            <Route path="/health-centers/add" render={()=><AddHealthCenterC setButtons={this.setButtons.bind(this)}/>}/>
                            <Route path="/health-centers" render={()=>
                                <DataItemsListC item_type="Health Center" uuid="019eb86f-b5fb-4b91-beff-a30609115a4d"/>
                            }/>
                        </Switch>
                    </Grid>
                </Grid>
